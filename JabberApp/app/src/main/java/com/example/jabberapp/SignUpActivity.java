...
import com.example.jabberapp.Models.Users;
import com.example.jabberapp.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    //progres dialog is for loading gif
        ...
        binding.btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                auth.createUserWithEmailAndPassword(binding.etEmail.getText().toString(),binding.etPassword.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    @Override
                    //exception is check at this point just below line
